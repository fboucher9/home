...
call s:do_highlight_list([
    ...
    \  ['LightGray', 'NONE', '#c8c8c8', '#000000']],
    \ [['StatusLine'],
    \  ['LightGray', 'NONE', '#c8c8c8', '#000000']],
    \ [['Statement', 'Comment', 'Type', 'StatusLineNC', 'VertSplit', 'LineNr', 'Folded', 'FoldColumn', 'SignColumn'],
    \  ['DarkGray', 'NONE', '#909090', '#000000']],
    \ [['Preproc', 'WildMenu', 'Directory', 'WarningMsg', 'ErrorMsg'],
    \  ['DarkCyan', 'NONE', 'DarkCyan', '#000000']],
    \ [['diffAdded', 'SpellCap', 'SpellRare', 'SpellBad', 'SpellLocal', 'Todo', 'Title', 'MoreMsg', 'Question', 'DiffAdd', 'DiffDelete', 'DiffChange'],
    \  ['DarkGreen', 'NONE', 'DarkGreen', '#000000']],
    \ [['Constant', 'diffRemoved'],
    \  ['Brown', 'NONE', '#af5f00', '#000000']],
    \ [['Visual', 'VisualNOS', 'Search'],
    \  ['Black', 'LightGray', '#000000', '#c8c8c8']],
    \ [['IncSearch', 'Cursor'],
    \  ['Black', 'Yellow', '#000000', 'Yellow']],
    \ [['Error'],
    \  ['DarkMagenta', 'NONE', 'DarkMagenta', '#000000']],
    \ [['CursorLine', 'CursorColumn', 'ColorColumn'],
    \  ['NONE', '235', 'NONE', '235']],
    \ [['DiffText'],
    \  ['LightGreen', 'NONE', 'LightGreen', '#000000']],
    \ [['SpecialKey'],
    \  ['LightBlue', 'NONE', 'LightBlue', '#000000']]
    \ ])
